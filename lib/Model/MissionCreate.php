...
/**
 * MissionCreate Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class MissionCreate implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'MissionCreate';
...
'geoloc' => 'getGeoloc'    ];
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['proov_code'] === null) {
            $invalidProperties[] = "'proov_code' can't be null";
        }
